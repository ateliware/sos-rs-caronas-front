...
To run the app in a dockerized environment, you can use the following commands:
...
```bash
docker build . -t blueprint-react
docker run -p 4000:4000 -d blueprint-react # Run the app on port 4000
```
